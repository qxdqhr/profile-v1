#!/usr/bin/env bash
# CI / 本地：安装 Godot 4.7.1 + export templates，并导出 Pulse Parade Web
set -euo pipefail
...
GAME_DIR="${REPO_ROOT}/games/pulse-parade"
OUT_DIR="${REPO_ROOT}/deploy/games/pulse-parade/www"
...
echo "Exporting Web (single-thread)..."
