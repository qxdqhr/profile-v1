...
export function getTeachHubOssFileBootstrap() {
...
export async function createTeachHubPersistentFileService() {
  return getTeachHubOssFileBootstrap().createPersistentFileService();
}
