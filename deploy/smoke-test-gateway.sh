...
check_http "GET /games/miku-click/" "${BASE}/games/miku-click/" "200"
check_http "GET /games/miku-click/index.wasm" "${BASE}/games/miku-click/index.wasm" "200"
check_http "GET /games/miku-click/index.pck" "${BASE}/games/miku-click/index.pck" "200"
check_http "GET /games/kannot/" "${BASE}/games/kannot/" "200"
check_http "GET /games/kannot/index.wasm" "${BASE}/games/kannot/index.wasm" "200"
check_http "GET /games/kannot/index.pck" "${BASE}/games/kannot/index.pck" "200"
check_http "GET /games/vocaloid-to-go/" "${BASE}/games/vocaloid-to-go/" "200"
check_http "GET /games/vocaloid-to-go/index.wasm" "${BASE}/games/vocaloid-to-go/index.wasm" "200"
check_http "GET /games/vocaloid-to-go/index.pck" "${BASE}/games/vocaloid-to-go/index.pck" "200"
check_http "GET /games/purchase-game/" "${BASE}/games/purchase-game/" "200"
check_http "GET /games/purchase-game/index.wasm" "${BASE}/games/purchase-game/index.wasm" "200"
check_http "GET /games/purchase-game/index.pck" "${BASE}/games/purchase-game/index.pck" "200"
check_http "GET /games/mikutap-game/" "${BASE}/games/mikutap-game/" "200"
check_http "GET /games/mikutap-game/index.wasm" "${BASE}/games/mikutap-game/index.wasm" "200"
check_http "GET /games/mikutap-game/index.pck" "${BASE}/games/mikutap-game/index.pck" "200"
