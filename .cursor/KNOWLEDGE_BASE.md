...
> Godot/静态游戏旁路见 `deploy/games/README.md`（现网：`/games/pulse-parade/`、`/games/flappy-wish/`、`/games/suika-game/`）。
...
- 源码：`games/<slug>/`（Godot 4，**非** `apps/*`）。现网：`pulse-parade`、`flappy-wish`、`suika-game`。
