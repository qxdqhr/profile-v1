...
// 扩展 Sprite 类型
export interface AnimatedFish extends Sprite {
    direction: number;
    speed: number;
    turnSpeed: number;
}

export function Fishes(app: Application, fishes: AnimatedFish[])
{
    ...
    for (let i = 0; i < fishCount; i++)
    {
        ...
        const fish = Sprite.from(fishAsset) as AnimatedFish;
...
export function animateFishes(app: Application, fishes: AnimatedFish[], time: { deltaTime: number })
{
