    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Screen Receiver 测试 */}
          <Link
            href="/examples/screen-receiver-test"
          ...
          {/* QQ Bot / NapCat */}
          <Link
            href="/examples/qqbot-napcat-demo"
          ...
          {/* 测测你是什么 */}
          <div
            onClick={() => router.push('/examples/test-yourself')}
          ...
          >
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
              <Link
                href="/examples/test-yourself-admin"
              ...
              <br />
              <Link
                href="/examples/test-yourself-admin-v2"
          ...
          {/* MMD渲染效果对比 */}
          <Link
            href="/examples/mmd-rendering-comparison"
            className="group block p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-2 border-cyan-200 dark:border-cyan-800"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="text-4xl">🎨</div>
          ...
          {/* MMD光照调试面板 */}
          <Link
            href="/examples/mmd-lighting-debug-demo"
