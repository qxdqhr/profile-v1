...
import { ScoreRecord, GameType, GameSettings } from '../constant/types';
import { TYPES_COUNT } from '../constant/const';
...
const gameTypes: GameType[] = [
  ...
  GameType.UpFalling,
  GameType.LeftFalling,
  GameType.RightFalling,
