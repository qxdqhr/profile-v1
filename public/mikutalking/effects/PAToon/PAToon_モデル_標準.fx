...
//影傾向テクスチャのフラグ（環境色Ｂの小数点にフラグが必要）
//#define USE_SHADOWBIAS_TOONTEX //環境色Ｂの小数点第５位を１にする
//#define USE_SHADOWBIAS_SUBTEX  //環境色Ｂの小数点第６位を１にする

//影傾向テクスチャの外部指定
//#define USE_SHADOWBIASMAP  "ShadowBiasMap.png"

//影傾向強度（１が通常、０でオフ。０．５～１．０くらい）
float SetShadingBiasPower = 1;


//ノーマルマップのフラグ（環境色Ｂの小数点にフラグが必要）
//#define USE_NORMALMAP_TOONTEX //環境色Ｂの小数点第５位を２にする
//#define USE_NORMALMAP_SUBTEX  //環境色Ｂの小数点第６位を２にする
...
#define BLENDDIFFUSE2TEXTURE "Tex/DiffuseMulc2.png"
