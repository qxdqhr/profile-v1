...
- [x] `dockerfile`：monorepo 安装 + `pnpm --filter @profile/web build` + standalone 路径 `app_web/web/server.js`
- [x] `components.json` 路径指向 `app_web/web`
- [x] 根脚本中 `src/` 引用已更新为 `@profile/*` 或 `app_web/web/src`
