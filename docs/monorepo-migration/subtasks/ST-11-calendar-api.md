...
- [x] `app_web/calendar/app/api/calendar/*`（re-export `@profile/calendar-core` handlers）
- [x] `app_web/calendar/app/api/auth/[...all]` — Better Auth
- [x] `app_web/calendar/app/api/ai/*` — 识图 / 设置面板（sa2kit 内置任务）
