...
| 项 | 决策 |
|----|------|
| ShowMasterpiece 双挂载 | **1a** — 直接删除主站 `web/web/src/app/api/showmasterpiece/**` |
...
| B4 | `web/web/src/db` 标 deprecated，仍 re-export `@profile/db` | ✅ |
...
| C4 | 规则/知识库路径 `web/web/src/modules`；Route Group 决策树 | ✅ |
