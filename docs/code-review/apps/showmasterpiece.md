...
| 项 | 内容 |
|----|------|
| 应用 | `apps/showmasterpiece`（:3003，basePath `/showmasterpiece`） |
...
| ID | 严重度 | 标题 | 位置 | 建议 | 状态 |
|----|--------|------|------|------|------|
| SM-001 | **P0** | web 仍挂载全套 `/api/showmasterpiece/**` | `apps/web/src/app/api/showmasterpiece/` | 生产摘除或 CI 冻结；防 drift | open |
