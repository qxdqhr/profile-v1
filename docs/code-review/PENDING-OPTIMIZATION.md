...
> **状态：OPT-01–07 已全部完成（队列空）。** 不要在普通任务里主动开新债。  
> **继续条件**：用户说 **「优化项目」**、**「继续优化」**、**「待定优化」** 且本文件又有未勾选项时再接着做。  
> Agent：先读本文件与 skill `.cursor/skills/continue-optimization-backlog/SKILL.md`；队列空则回报并停。

来源：2026-09-02 架构审查里当时没排完、以及减负时明确后置的项。已完成的安全/鉴权/Dockerfile/游戏旁路见 [`2026-09-02-审查结果.md`](./2026-09-02-审查结果.md)。

**下次从这里开始：** （无；新债另开项后再写 ID）
