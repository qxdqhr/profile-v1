...
| 消费方 | 实际依赖 |
|--------|----------|
| `app_web/web` HomeV2 | `@sa2kit-ui/react` → `@qhr123/sa2kit-ui-react@0.1.6` ✅ |
| `app_web/web` Home / fitnessPlan | 源码写 `animal-island-ui`，靠 **webpack alias** 偷换到 `@sa2kit-ui/react` |
...
| SUI-011 | P2 | web 未声明 animal-island-ui，依赖 alias | app_web/web | 迁移后删除 alias | open |
