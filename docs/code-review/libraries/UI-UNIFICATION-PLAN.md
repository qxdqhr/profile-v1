...
animal-island-ui@0.9.8
    ▲ 真依赖
 calendar-core / teach-hub-core / app_web/calendar|teach-hub
...
|----|:---:|:---:|:---:|:---:|
| app_web/web | 字面 import + **alias** | HomeV2 直连 | 实验页 | — |
| calendar-core / app_web/calendar | ✅ 真依赖 | ❌ | 少量 | — |
| teach-hub-core / app_web/teach-hub | ✅ 真依赖 | ❌ | ❌ | — |
| showmasterpiece | ✅ **死依赖** | ❌ | — | — |
...
| 步骤 | 仓 | 内容 | 验收 |
|------|-----|------|------|
| U2.1 | calendar-core + app_web/calendar | animal-island → 门面；删依赖 | ✅ 源码换轨；`pnpm --filter @profile/calendar build` 绿 |
| U2.2 | teach-hub-core + app_web/teach-hub | 同上 | ✅ 源码换轨 |
| U2.3 | app_web/showmasterpiece | 删死依赖 animal-island + transpile | ✅ |
...
| U3.2 | 删除 `app_web/web/next.config.ts` animal-island alias | ✅ |
