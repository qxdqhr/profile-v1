...
export default function UserHistoryPage() {
  ...
  return (
    <div className="min-h-screen bg-prussian-blue-50/50">
      <div className="max-w-6xl mx-auto p-4 sm:p-6">
        {/* 返回按钮 */}
        <div className="mb-6">
          <Link
            href={showmasterpiecePagePath('/')}
            className="inline-flex items-center gap-2 text-prussian-blue-600 hover:text-rich-black transition-colors"
          >
            <ArrowLeft size={20} />
            返回画集展示
          </Link>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-4">
                <User size={32} className="text-moonstone" />
              </div>
              <h1 className="text-2xl font-bold text-rich-black mb-2">查看预订历史</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-moonstone/25 ${
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-moonstone to-cerulean text-white py-2 px-4 rounded-lg font-medium hover:from-cerulean hover:to-moonstone transition-colors"
                >
                  <Search size={16} />
                  查询历史记录
                </button>
