...
function CalendarPageContent({ toolsPanel }: CalendarPageProps) {
...
export default function CalendarPage({ toolsPanel }: CalendarPageProps = {}) {
  return (
    <AuthProvider>
      <AiApiSettingsProvider defaultSettings={DEFAULT_CALENDAR_AI_API_SETTINGS}>
        <CalendarSettingsProvider>
          <CalendarPageContent toolsPanel={toolsPanel} />
        </CalendarSettingsProvider>
